...
function comparer(idx, asc) {
    return (a, b) => foo(getCellValue(asc ? a : b, idx), getCellValue(asc ? b : a, idx));
}

function newcomparer(col, reverse) {
    return (a, b) => reverse * foo(getCellValue(a, col), getCellValue(b, col));
}
...
// window.onload :issa kutsutaan makeAllSortable()
